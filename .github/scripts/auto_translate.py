...
def get_changed_english_files():
    ...
    if result.returncode != 0:
        # Fallback: if HEAD~1 doesn't exist, translate all English files
...
def main():
    ...
    # Commit and push
    print(f"\nCommitting {len(translated)} translated file(s)...")
    subprocess.run(
    ...
    print(f"Pushed {len(translated)} translation(s) to main.")
    print("Deploy workflow will be triggered automatically.")
