...
## Ink Cartridge Replacement (Inkjet Printers)
...
|-----------|----------------|
| Weight | 75–90 g/m² (20–24 lb) for general use |
...
## Consumable Inventory Log

Track consumable stock with this template:

| Item | Model / Part # | Printer Model | In Stock | On Order | Reorder Level | Last Ordered |
|------|---------------|---------------|----------|----------|---------------|--------------|
| Toner (Black) | | | | | | |
| Toner (Cyan) | | | | | | |
| Drum Unit | | | | | | |
