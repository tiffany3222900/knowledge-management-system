...
- **Duplexer path** — paper passing through may be hot to the touch
...
- Never use water on an electrical fire — use a CO₂ or dry chemical extinguisher.
...
3. Use a Class C fire extinguisher (CO₂ or dry chemical) — **never water**.
...
## Safety Checklist (Post Every Printer)
